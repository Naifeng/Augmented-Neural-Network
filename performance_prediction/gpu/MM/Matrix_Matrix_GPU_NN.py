...
FILENAME = "matrix_matrix_gpu_500_points_Tesla.csv"
...
L1 = tf.layers.dense(x, 9, tf.nn.relu, kernel_regularizer=tf.keras.regularizers.l2(0.01))
...
with tf.Session() as sess:
    ...
    for i in range(30000):
        ...
        if i % 500 == 0:
            ...
            print("MAPE: ", str(round(sum_ape / c, 2)))
