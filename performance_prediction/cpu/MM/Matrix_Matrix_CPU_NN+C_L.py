...
FILENAME = "matrix_matrix_cpu_5000_points_I7.csv"
...
L1 = tf.layers.dense(x, 15, tf.nn.relu, kernel_regularizer=tf.keras.regularizers.l2(0.01))
#L2 = tf.layers.dense(L1, 15, tf.nn.relu, kernel_regularizer=tf.keras.regularizers.l2(0.01))
#L3 = tf.layers.dense(L2, 15, tf.nn.relu, kernel_regularizer=tf.keras.regularizers.l2(0.01))
