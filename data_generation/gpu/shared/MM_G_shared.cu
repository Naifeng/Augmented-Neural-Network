...
__global__ void MM(int* A, int* B, int* C, int ARows, int ACols, int BRows,
...
int main(int argc, char const *argv[])
{
    ...
    ofile.open("matrix_matrix_gpu_500_points_2.csv"); 
    ...
    for (int iterator = 0; iterator < NUM; iterator++) { 
        ...
        MM << < dimGrid, dimBlock >> > (d_a, d_b, d_c, m, n, n, k, m, k);
